/*
You are given a string num, which represents a large integer. You are also given
a 0-indexed integer array change of length 10 that maps each digit 0-9 to
...
int main() {
  cout << maximumNumber("132", {9, 8, 5, 0, 3, 6, 4, 2, 6, 8}) << endl;
  cout << maximumNumber("021", {9, 4, 3, 5, 7, 2, 1, 9, 0, 6}) << endl;
  cout << maximumNumber("5", {1, 4, 7, 5, 3, 2, 5, 6, 9, 4}) << endl;
  return 0;
}