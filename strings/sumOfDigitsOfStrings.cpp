...
int digitsSumAfterConvertion(const string &input, int k) {
  int ret = 0;
...
int main() {
  cout << digitsSumAfterConvertion("iiii", 1) << endl;
  cout << digitsSumAfterConvertion("leetcode", 2) << endl;
  cout << digitsSumAfterConvertion("zbax", 2) << endl;
  return 0;
}